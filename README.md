...
You have seen a few workflows in this repository. They are quality-gates to prevent duplication, control complexity and prove functionality. Do you think some of them have potential to guide code-improvements in your team? Yes they have the potential to improve the code

During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)
To write test spec and proper unit testing to reduce the bugs and increase the code efficiency
